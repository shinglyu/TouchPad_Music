...
for i=1:length(varargin)
	...
	elseif strcmp(varargin(i),'beat'), timeformat='beat'; 
	elseif strcmp(varargin(i),'sec'), timeformat='sec';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	max_duration=round(max(onset(nmat,timetype))+ dur(nmat(end,:),timetype)); %OK
