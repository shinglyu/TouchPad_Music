...
% Authors:
%  Date		Time	Prog	Note
% 1.7.2002	21:47	TE	Created under MATLAB 5.3 (PC)
...
switch lower(stat),
 ...
 case 'pc_europe_min'
	% Essen Collection: Minor songs, not incl. Asian (r with above, .98)
	ref = [0.153,0.002,0.148,0.083,0.139,0.133,0.004,0.209,0.017,0.052,0.029,0.030];
	label = {'C','C#','D','D#','E','F','F#','G','G#','A','A#','B'};
	label=cellstr(label')';
 ...
 case 'iv_europe'
	...
	ivdist_all = [0.0013;0.0000;0.0008;0.0019;0.0033;0.0093;0.0018;0.0191;0.0281;
 ...
 case 'ivdia_europe'
	...
	int_dia_label = {'-8','-7','-6','-5','-4','-3','-2','-1','2','3','4','5','6','7','8'};
	label=cellstr(label')';
...
0,0.0000,0.0001,0.0000,0.0013,0.0000,0.0140,0.0000,0.0156];
	label = {'1','2','3','4','5','6','7','8','9'}; % pitäisi keksiä paremmat nimet kestoille
	label=cellstr(label')';
