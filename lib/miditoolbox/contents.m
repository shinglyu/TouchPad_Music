...
% readmidi       - Reads a MIDI file to a notematrix
% writemidi      - Writes a MIDI file from a notematrix
%
%GENERATION FUNCTIONS
% createnmat     - Create a notematrix from the input arguments
% setmidiplayer  - Define external MIDI player
% nmat2snd       - Synthesize NMAT using simple synthesis
% playmidi       - Plays NMAT using external MIDI player
...
% kkcc           - Correlation of the pitch class distribution to K & K profiles
...
% meteraccent    - Measure of phenomenal accent synchrony (Eerola, 2003)
...
% gettempo       - Get tempo (in BPM)
% meter          - Autocorrelation-based estimate of meter (Toiviainen & Eerola, 2004)
