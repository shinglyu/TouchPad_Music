...
% ans = 5.151
%
% The answer means that the tune is somewhat more complicated 
% than the average tune in Essen collection (0.151 standard deviations higher).
%
% References:
